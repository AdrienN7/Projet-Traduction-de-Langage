...
# 105 "sourceEtu/parser.mly"
                (e1::le)
# 150 "sourceEtu/parser.ml"
         in
...
# 11 "sourceEtu/parser.mly"
       (string)
# 360 "sourceEtu/parser.ml"
        ))), _, (lp : ((Type.typ * string) list))) = _menhir_stack in
        let _v : ((Type.typ * string) list) = 
# 81 "sourceEtu/parser.mly"
                          ((t,n)::lp)
# 365 "sourceEtu/parser.ml"
         in
...
# 532 "sourceEtu/parser.ml"
    ...
    | MenhirState7 ->
        ...
        | PF ->
            ...
            let _v : (Ast.AstSyntax.expression) = 
# 101 "sourceEtu/parser.mly"
                          (exp)
# 629 "sourceEtu/parser.ml"
             in
            _menhir_goto_e _menhir_env _menhir_stack _menhir_s _v
        | PLUS ->
            let _menhir_stack = Obj.magic _menhir_stack in
...
# 744 "sourceEtu/parser.ml"
    ...
    | MenhirState43 ->
        ...
        | PV ->
            ...
            let ((_menhir_stack, _menhir_s), _, (exp : (Ast.AstSyntax.expression))) = _menhir_stack in
            let _v : (Ast.AstSyntax.instruction) = 
# 77 "sourceEtu/parser.mly"
                                    (Retour (exp))
# 777 "sourceEtu/parser.ml"
             in
            _menhir_goto_i _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 11 "sourceEtu/parser.mly"
       (string)
# 857 "sourceEtu/parser.ml"
            ))), _, (e1 : (Ast.AstSyntax.expression))) = _menhir_stack in
            let _v : (Ast.AstSyntax.instruction) = 
# 71 "sourceEtu/parser.mly"
                                    (Declaration (t,n,e1))
# 862 "sourceEtu/parser.ml"
             in
            _menhir_goto_i _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 11 "sourceEtu/parser.mly"
       (string)
# 1082 "sourceEtu/parser.ml"
                    ))), (e : (
# 10 "sourceEtu/parser.mly"
       (int)
# 1086 "sourceEtu/parser.ml"
                    ))) = _menhir_stack in
                    let _v : (Ast.AstSyntax.instruction) = 
# 73 "sourceEtu/parser.mly"
                                    (Constante (n,e))
# 1091 "sourceEtu/parser.ml"
                     in
                    _menhir_goto_i _menhir_env _menhir_stack _menhir_s _v
                | _ ->
                    assert (not _menhir_env._menhir_error);
...
# 11 "sourceEtu/parser.mly"
       (string)
# 1213 "sourceEtu/parser.ml"
    )) = _v in
    let _v : (Ast.AstSyntax.expression) = 
# 91 "sourceEtu/parser.mly"
                          (Ident n)
# 1218 "sourceEtu/parser.ml"
     in
    _menhir_goto_e _menhir_env _menhir_stack _menhir_s _v
...
# 10 "sourceEtu/parser.mly"
       (int)
# 1244 "sourceEtu/parser.ml"
    )) = _v in
    let _v : (Ast.AstSyntax.expression) = 
# 94 "sourceEtu/parser.mly"
                          (Entier e)
# 1249 "sourceEtu/parser.ml"
     in
    _menhir_goto_e _menhir_env _menhir_stack _menhir_s _v
...
and _menhir_run1 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    ...
    let _menhir_stack = Obj.magic _menhir_stack in
    let _v : (Type.typ) = 
# 86 "sourceEtu/parser.mly"
          (Rat)
# 1644 "sourceEtu/parser.ml"
     in
